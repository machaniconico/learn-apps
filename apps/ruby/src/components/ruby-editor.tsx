...
const DEFAULT_CODE = `# Rubyコードを確認してみましょう！
    ...
    <div className="rounded-xl border border-gray-700 overflow-hidden bg-gray-900">
      <div className="flex items-center justify-between px-4 py-2 bg-gray-800 border-b border-gray-700">
        <div className="flex items-center gap-2">
          <span className="text-red-400 font-mono text-sm font-semibold">Ruby</span>
      ...
      <CodeMirror value={code} height={height} extensions={[lintExtension, javascript(), basicSetup, ...(showHint ? [placeholderExtension] : [])]} theme={oneDark} onChange={setCode} className="text-sm" />
