...
const NAV_GROUPS = [
  {
    label: "入門",
    items: [
      { href: "/learn/basics", label: "Ruby基礎" },
  ...
  },
  {
    label: "データ構造",
    items: [
      { href: "/learn/arrays", label: "配列" },
      { href: "/learn/hashes", label: "ハッシュ" },
  ...
  },
  {
    label: "シンボル・ブロック",
    items: [
      { href: "/learn/symbols", label: "シンボル" },
      { href: "/learn/blocks", label: "ブロック・Proc・Lambda" },
    ],
  },
  {
    label: "オブジェクト指向",
    items: [
      ...
      { href: "/learn/inheritance", label: "継承" },
      { href: "/learn/modules", label: "モジュール" },
    ],
  },
  {
    label: "エラー・I/O",
    items: [
      ...
      { href: "/learn/io", label: "ファイルI/O" },
    ],
  },
  {
    label: "コレクション",
    items: [
      { href: "/learn/enumerable", label: "Enumerable" },
      { href: "/learn/regex", label: "正規表現" },
      { href: "/learn/numbers", label: "数値と演算" },
    ],
  },
  {
    label: "上級",
    items: [
      { href: "/learn/metaprogramming", label: "メタプログラミング" },
      { href: "/learn/testing", label: "テスト" },
      { href: "/learn/gems", label: "Gem・Bundler" },
    ],
  },
  {
    label: "Web開発",
    items: [
      { href: "/learn/rails", label: "Rails入門" },
      { href: "/learn/web", label: "Web基礎" },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/learn/ecosystem", label: "Rubyエコシステム" },
    ],
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center justify-between h-14">
          ...
          <Link href="/" className="flex items-center font-bold text-lg shrink-0">
            ...
            <span className="text-gray-100">RubyLearn</span>
            <span className="text-red-400">/&gt;</span>
          </Link>
