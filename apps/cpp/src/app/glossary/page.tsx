...
const ALL_CATEGORIES = ["すべて", "基礎", "ポインタ・参照", "OOP", "テンプレート", "STL", "メモリ", "マルチスレッド", "ビルド"] as const;

const CATEGORY_COLORS: Record<string, string> = {
  "基礎": "bg-blue-500/20 text-blue-400 border-blue-500/30",
  "ポインタ・参照": "bg-cyan-500/20 text-cyan-400 border-cyan-500/30",
  "OOP": "bg-violet-500/20 text-violet-400 border-violet-500/30",
  "テンプレート": "bg-teal-500/20 text-teal-400 border-teal-500/30",
  "STL": "bg-green-500/20 text-green-400 border-green-500/30",
  "メモリ": "bg-orange-500/20 text-orange-400 border-orange-500/30",
  "マルチスレッド": "bg-pink-500/20 text-pink-400 border-pink-500/30",
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-3">
            ...
            <h1 className="text-3xl font-bold text-gray-100">C++用語集</h1>
          </div>
          <p className="text-gray-400">
            C++プログラミングで頻出する用語を、カテゴリ別にまとめました。
          </p>
        ...
        <div className="relative mb-5">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-3 bg-gray-900 border border-gray-700 rounded-xl text-gray-100 placeholder-gray-600 outline-none focus:border-blue-500/50 transition-colors text-sm"
          />
          {query && (
            <button
              onClick={() => setQuery("")}
