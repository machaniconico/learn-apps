...
const NAV_GROUPS = [
  {
    label: "入門",
    items: [
      { href: "/learn/basics", label: "Java基礎" },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/learn/stream", label: "Stream API" },
      { href: "/learn/optional", label: "Optional" },
    ],
  },
  {
    label: "Web開発",
    items: [
      { href: "/learn/springboot", label: "Spring Boot" },
      { href: "/learn/springmvc", label: "Spring MVC" },
      { href: "/learn/jpa", label: "JPA・DB" },
    ],
  },
  {
    label: "テスト・品質",
    items: [
      { href: "/learn/junit", label: "JUnit" },
  ...
  },
  {
    label: "ビルド",
    items: [
      { href: "/learn/build", label: "Maven・Gradle" },
      { href: "/learn/packages", label: "パッケージ・モジュール" },
    ],
  },
  {
    label: "スキルアップ",
    items: [
      ...
      { href: "/learn/ecosystem", label: "Javaエコシステム" },
    ],
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center justify-between h-14">
          ...
          <Link href="/" className="flex items-center font-bold text-lg shrink-0">
            ...
            <span className="text-gray-100">JavaLearn</span>
            <span className="text-orange-400">/&gt;</span>
          </Link>
