...
import { lintJava } from "../lib/linter";
...
const DEFAULT_CODE = `// Javaコードを確認してみましょう！
public class Main {
...
export function JavaEditor({ defaultCode = DEFAULT_CODE, height = "300px" }: JavaEditorProps) {
  ...
  const lintExtension = useMemo(
    () => createEditorLinter(lintJava, setProblems),
    [],
  );
    ...
    <div className="rounded-xl border border-gray-700 overflow-hidden bg-gray-900">
      <div className="flex items-center justify-between px-4 py-2 bg-gray-800 border-b border-gray-700">
        <div className="flex items-center gap-2">
          <span className="text-orange-400 font-mono text-sm font-semibold">Java</span>
      ...
      <CodeMirror value={code} height={height} extensions={[java(), basicSetup, lintExtension]} theme={oneDark} onChange={(val) => { setCode(val); }} className="text-sm" />
