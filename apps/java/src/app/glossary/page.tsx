...
const ALL_CATEGORIES = ["すべて", "基礎", "OOP", "コレクション", "ラムダ・Stream", "Web開発", "並行処理", "ビルド"] as const;

const CATEGORY_COLORS: Record<string, string> = {
  "基礎": "bg-orange-500/20 text-orange-400 border-orange-500/30",
  "OOP": "bg-violet-500/20 text-violet-400 border-violet-500/30",
  "コレクション": "bg-green-500/20 text-green-400 border-green-500/30",
  "ラムダ・Stream": "bg-cyan-500/20 text-cyan-400 border-cyan-500/30",
  "Web開発": "bg-blue-500/20 text-blue-400 border-blue-500/30",
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-3">
            ...
            <h1 className="text-3xl font-bold text-gray-100">Java用語集</h1>
          </div>
          <p className="text-gray-400">
            Javaプログラミングで頻出する用語を、カテゴリ別にまとめました。
          </p>
