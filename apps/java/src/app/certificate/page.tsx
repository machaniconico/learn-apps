        ...
        <div className="max-w-md w-full text-center">
          <div className="bg-gray-900 border border-gray-800 rounded-2xl p-8">
            ...
            <div className="space-y-3">
              <Link
                href="/final-exam"
                className="block w-full bg-orange-500 hover:bg-orange-400 text-gray-950 font-semibold py-3 rounded-lg transition-colors"
              >
                最終試験を受ける
              </Link>
              <Link
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="flex flex-wrap gap-4 justify-end mb-6 print:hidden">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 bg-orange-500 hover:bg-orange-400 text-gray-950 font-semibold px-5 py-2.5 rounded-lg text-sm transition-colors"
          >
            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="relative bg-white rounded-2xl p-1.5 shadow-2xl shadow-orange-900/20">
          ...
          <div className="rounded-xl border-4 border-orange-700 p-1.5">
            {/* Border layer 2 */}
            <div className="rounded-lg border-2 border-amber-500 p-1.5">
              {/* Border layer 3 */}
              <div className="rounded-md border border-orange-400 p-1.5">
                {/* Border layer 4 - innermost */}
                <div className="rounded border border-amber-300/60 bg-gradient-to-br from-orange-50 to-amber-50 px-8 py-10 sm:px-14 sm:py-14">
                  ...
                  <div className="text-center mb-8">
                    <p className="text-sm font-medium tracking-[0.3em] text-amber-700 uppercase mb-3">
                      Certificate of Completion
                    </p>
                    <h1 className="text-5xl sm:text-6xl font-bold text-orange-900 tracking-wide mb-2"
                  ...
                  {/* Recipient */}
                  <div className="text-center mb-8">
                    <p className="text-sm text-amber-700 mb-3">以下の方がプログラムを修了したことを証明します</p>
                  ...
                  <div className="text-center mb-8 bg-white/60 rounded-xl px-6 py-4 border border-orange-200">
                    <p className="text-sm text-amber-700 mb-1">修了プログラム</p>
                    <p className="text-xl font-bold text-orange-900">JavaLearn Java学習プログラム</p>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-8">
                    {examResult && (
                      <div className="text-center bg-white/60 rounded-xl px-4 py-4 border border-orange-200">
                        <p className="text-xs text-amber-700 mb-1">最終試験スコア</p>
                        <p className="text-3xl font-bold text-orange-800">{examResult.score}<span className="text-lg font-normal">点</span></p>
                      </div>
                    )}
                    <div className="text-center bg-white/60 rounded-xl px-4 py-4 border border-orange-200">
                      <p className="text-xs text-amber-700 mb-1">完了レッスン数</p>
                  ...
                  {completedCategoryNames.length > 0 && (
                    <div className="mb-8 bg-white/60 rounded-xl px-5 py-4 border border-orange-200">
                      <p className="text-sm font-medium text-amber-700 mb-3 text-center">修了カテゴリ</p>
