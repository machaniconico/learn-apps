  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-10">
      ...
      <section className="mb-10">
        ...
        <CSharpEditor
          defaultCode={`// break: 5が見つかったらループ終了
Console.Write("break例: ");
for (int i = 0; i < 10; i++)
{
    if (i == 5) break;
    Console.Write($"{i} ");
...
if (found)
    Console.WriteLine($"5は [{targetRow}, {targetCol}] にあります");
