...
const ALL_CATEGORIES = ["すべて", "基礎", "データ構造", "OOP", "LINQ", "非同期", "Web", "テスト", "応用"] as const;

const CATEGORY_COLORS: Record<string, string> = {
  "基礎": "bg-purple-500/20 text-purple-400 border-purple-500/30",
  "データ構造": "bg-blue-500/20 text-blue-400 border-blue-500/30",
  "OOP": "bg-violet-500/20 text-violet-400 border-violet-500/30",
  "LINQ": "bg-cyan-500/20 text-cyan-400 border-cyan-500/30",
  "非同期": "bg-teal-500/20 text-teal-400 border-teal-500/30",
  "Web": "bg-blue-500/20 text-blue-400 border-blue-500/30",
  "テスト": "bg-pink-500/20 text-pink-400 border-pink-500/30",
  "応用": "bg-indigo-500/20 text-indigo-400 border-indigo-500/30",
};
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="relative mb-5">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-3 bg-gray-900 border border-gray-700 rounded-xl text-gray-100 placeholder-gray-600 outline-none focus:border-purple-500/50 transition-colors text-sm"
          />
          {query && (
            <button
              onClick={() => setQuery("")}
