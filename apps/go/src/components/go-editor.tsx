...
export function GoEditor({ defaultCode = DEFAULT_CODE, height = "300px" }: GoEditorProps) {
      ...
      <div className="flex items-center justify-between px-4 py-2 bg-gray-800 border-b border-gray-700">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            onClick={runCode}
            disabled={loading}
            className="flex items-center gap-1.5 bg-cyan-600 hover:bg-cyan-500 disabled:bg-cyan-800 disabled:cursor-not-allowed text-white text-sm font-medium px-3 py-1.5 rounded transition-colors"
          >
            {loading ? (
              <>
