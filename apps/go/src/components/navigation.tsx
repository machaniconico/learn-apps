...
const NAV_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/learn/interfaces", label: "インターフェース" },
  ...
  },
  {
    label: "データ構造",
    items: [
      { href: "/learn/arrays", label: "配列・スライス" },
      { href: "/learn/maps", label: "マップ" },
  ...
  },
  {
    label: "エラー・並行",
    items: [
      { href: "/learn/errors", label: "エラー処理" },
      { href: "/learn/goroutines", label: "ゴルーチン" },
      { href: "/learn/channels", label: "チャネル" },
    ],
  },
  {
    label: "パッケージ",
    items: [
      { href: "/learn/packages", label: "パッケージ" },
  ...
  },
  {
    label: "Web開発",
    items: [
      { href: "/learn/http", label: "HTTP・Web" },
      { href: "/learn/json", label: "JSON処理" },
    ],
  },
  {
    label: "テスト・CLI",
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/learn/context", label: "コンテキスト" },
  ...
  },
  {
    label: "スキルアップ",
    items: [
      { href: "/learn/concurrency", label: "並行パターン" },
      { href: "/learn/design", label: "設計パターン" },
      { href: "/learn/algorithms", label: "アルゴリズム" },
      { href: "/learn/ecosystem", label: "Goエコシステム" },
    ],
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center justify-between h-14">
          ...
          <Link href="/" className="flex items-center font-bold text-lg shrink-0">
            ...
            <span className="text-gray-100">GoLearn</span>
            <span className="text-cyan-400">/&gt;</span>
          </Link>
