...
export const JS_LESSONS: Lesson[] = [
  ...
  { id: "regex", title: "正規表現", description: "パターンマッチング、test、match、replace、キャプチャグループ", category: "javascript", order: 5 },
  { id: "arrays", title: "配列メソッド", description: "map、filter、reduce、find、sort", category: "javascript", order: 6 },
  { id: "objects", title: "オブジェクト詳細", description: "プロパティ、メソッド、分割代入", category: "javascript", order: 7 },
  { id: "loops", title: "ループ", description: "for、while、for...of、forEach", category: "javascript", order: 8 },
  { id: "functions", title: "関数詳細", description: "アロー関数、スコープ、クロージャ", category: "javascript", order: 9 },
  { id: "classes", title: "クラスとOOP", description: "class、constructor、extends、継承", category: "javascript", order: 10 },
  { id: "errors", title: "エラーハンドリング", description: "try/catch、throw、カスタムエラー", category: "javascript", order: 11 },
  { id: "async", title: "非同期処理", description: "Promise、async/await、コールバック", category: "javascript", order: 12 },
  { id: "fetch-api", title: "Fetch API", description: "HTTPリクエスト、JSONの取得・送信", category: "javascript", order: 13 },
  { id: "storage", title: "ローカルストレージ", description: "データの永続化、JSON変換", category: "javascript", order: 14 },
  { id: "modules", title: "モジュール", description: "import/export、コードの分割", category: "javascript", order: 15 },
  { id: "js-exercise", title: "JavaScript総合演習", description: "TODOアプリを作ろう", category: "javascript", order: 16 },
];
