      ...
      <section className="relative overflow-hidden py-24 px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative max-w-5xl mx-auto text-center">
          ...
          <p className="text-lg sm:text-xl text-gray-400 max-w-2xl mx-auto mb-10 leading-relaxed">
            C言語の基礎からシステムプログラミング、データ構造まで。
            ブラウザ上でコードを書きながら学びましょう。
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/learn/basics"
              className="inline-flex items-center justify-center gap-2 bg-teal-500 hover:bg-teal-400 text-gray-950 font-semibold px-8 py-3 rounded-lg transition-colors"
            >
              無料で始める
        ...
        <div className="max-w-2xl mx-auto text-center">
          <div className="bg-gradient-to-br from-teal-500/10 to-cyan-600/10 border border-teal-500/20 rounded-2xl p-10">
            ...
            <p className="text-gray-400 mb-8">
              まずはC言語基礎から始めて、着実にスキルを積み上げていきましょう。
            </p>
            <Link
              href="/learn/basics"
              className="inline-flex items-center gap-2 bg-teal-500 hover:bg-teal-400 text-gray-950 font-bold px-8 py-4 rounded-xl text-lg transition-colors"
            >
              C言語基礎から始める
