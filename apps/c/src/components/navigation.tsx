...
const NAV_GROUPS = [
  ...
  },
  {
    label: "ポインタ",
    items: [
      { href: "/learn/pointers", label: "ポインタ基礎" },
      { href: "/learn/pointer-apps", label: "ポインタ応用" },
    ],
  },
  {
    label: "データ構造",
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/learn/enums", label: "列挙型・typedef" },
    ],
  },
  {
    label: "プリプロセッサ・I/O",
    items: [
      ...
      { href: "/learn/stdio", label: "標準入出力" },
      { href: "/learn/fileio", label: "ファイル操作" },
    ],
  },
  {
    label: "ビット・ライブラリ",
    items: [
      { href: "/learn/bitwise", label: "ビット演算" },
  ...
  },
  {
    label: "データ構造実装",
    items: [
      { href: "/learn/linked-list", label: "連結リスト" },
      { href: "/learn/stack-queue", label: "スタック・キュー" },
    ],
  },
  {
    label: "アルゴリズム",
    items: [
      { href: "/learn/sorting", label: "ソート" },
      { href: "/learn/searching", label: "探索" },
    ],
  },
  {
    label: "システム",
    items: [
      { href: "/learn/process", label: "プロセス・シグナル" },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/learn/multifile", label: "マルチファイル" },
    ],
  },
  {
    label: "応用",
    items: [
      { href: "/learn/idioms", label: "Cイディオム" },
      { href: "/learn/ecosystem", label: "Cエコシステム" },
    ],
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center justify-between h-14">
          ...
          <Link href="/" className="flex items-center font-bold text-lg shrink-0">
            ...
            <span className="text-gray-100">CLearn</span>
            <span className="text-teal-400">/&gt;</span>
          </Link>
