...
const NAV_GROUPS = [
  {
    label: "入門",
    items: [
      { href: "/learn/basics", label: "Kotlin基礎" },
  ...
  },
  {
    label: "Kotlin特有",
    items: [
      { href: "/learn/null-safety", label: "Null安全" },
      { href: "/learn/extensions", label: "拡張関数" },
      { href: "/learn/data-sealed", label: "データクラス・Sealed" },
    ],
  },
  {
    label: "関数型",
    items: [
      { href: "/learn/lambda", label: "ラムダ式" },
      { href: "/learn/collection-ops", label: "コレクション操作" },
      { href: "/learn/scope-functions", label: "スコープ関数" },
    ],
  },
  {
    label: "非同期",
    items: [
      { href: "/learn/coroutines", label: "Coroutines" },
      { href: "/learn/flow", label: "Flow" },
    ],
  },
  {
    label: "テスト・品質",
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/learn/delegation", label: "委譲" },
    ],
  },
  {
    label: "ビルド",
    items: [
      { href: "/learn/build", label: "Gradle・ビルド" },
    ],
  },
  {
    label: "スキルアップ",
    items: [
      ...
      { href: "/learn/ecosystem", label: "Kotlinエコシステム" },
    ],
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center justify-between h-14">
          ...
          <Link href="/" className="flex items-center font-bold text-lg shrink-0">
            ...
            <span className="text-gray-100">KotlinLearn</span>
            <span className="text-violet-400">/&gt;</span>
          </Link>
