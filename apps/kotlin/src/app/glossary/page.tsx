...
const ALL_CATEGORIES = ["すべて", "基礎", "OOP", "コレクション", "関数型", "非同期", "ビルド", "Kotlin特有"] as const;

const CATEGORY_COLORS: Record<string, string> = {
  "基礎": "bg-violet-500/20 text-violet-400 border-violet-500/30",
  "OOP": "bg-purple-500/20 text-purple-400 border-purple-500/30",
  "コレクション": "bg-green-500/20 text-green-400 border-green-500/30",
  "関数型": "bg-cyan-500/20 text-cyan-400 border-cyan-500/30",
  "非同期": "bg-pink-500/20 text-pink-400 border-pink-500/30",
  "ビルド": "bg-indigo-500/20 text-indigo-400 border-indigo-500/30",
  "Kotlin特有": "bg-fuchsia-500/20 text-fuchsia-400 border-fuchsia-500/30",
};
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-3">
            ...
            <h1 className="text-3xl font-bold text-gray-100">Kotlin用語集</h1>
          </div>
          <p className="text-gray-400">
            Kotlinプログラミングで頻出する用語を、カテゴリ別にまとめました。
          </p>
        ...
        <div className="relative mb-5">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-3 bg-gray-900 border border-gray-700 rounded-xl text-gray-100 placeholder-gray-600 outline-none focus:border-violet-500/50 transition-colors text-sm"
          />
          {query && (
            <button
              onClick={() => setQuery("")}
