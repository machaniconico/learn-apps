...
export default function WithApplyLetPage() {
  return (
    <div className="max-w-6xl mx-auto px-4 py-10">
      <div className="mb-8">
        <span className="text-pink-400 text-sm font-semibold">ラムダ式 レッスン8</span>
      ...
      <section className="mb-10">
        ...
        <p className="text-gray-400 mb-4">
          <code className="text-pink-300">apply</code>はオブジェクトにブロックを適用し、オブジェクト自身を返します。thisでアクセスします。
        </p>
        <KotlinEditor
...
fun main() {
    ...
    println(person)
      ...
      <section className="mb-10">
        ...
        <p className="text-gray-400 mb-4">
          <code className="text-pink-300">let</code>はオブジェクトをブロックの引数（it）として渡し、ブロックの結果を返します。
        </p>
        <KotlinEditor
...
Hello Kotlin`}
      ...
      <section className="mb-10">
        ...
        <p className="text-gray-400 mb-4">
          <code className="text-pink-300">with</code>はレシーバを引数として渡し結果を返します。<code className="text-pink-300">run</code>はthisでアクセスして結果を返します。
        </p>
        <KotlinEditor
...
ソート後: [1, 1, 3, 4, 5]`}
      ...
      <div className="mb-8">
        <LessonCompleteButton categoryId="lambda" lessonId="with-apply-let" />
      </div>
      <LessonNav lessons={lessons} currentId="with-apply-let" basePath="/learn/lambda" />
    </div>
  );
}
