...
const NAV_GROUPS = [
  {
    label: "入門",
    items: [
      { href: "/learn/basics", label: "Swift基礎" },
  ...
  },
  {
    label: "データ",
    items: [
      { href: "/learn/collections", label: "コレクション" },
      { href: "/learn/strings", label: "文字列操作" },
      { href: "/learn/optionals", label: "Optional" },
    ],
  },
  {
    label: "クロージャ・構造体",
    items: [
      { href: "/learn/closures", label: "クロージャ" },
      { href: "/learn/structs", label: "構造体" },
    ],
  },
  {
    label: "オブジェクト指向",
    items: [
      { href: "/learn/classes", label: "クラス" },
      { href: "/learn/enums", label: "列挙型" },
      { href: "/learn/protocols", label: "プロトコル" },
    ],
  },
  {
    label: "型システム",
    items: [
      { href: "/learn/extensions", label: "エクステンション" },
      { href: "/learn/generics", label: "ジェネリクス" },
    ],
  },
  {
    label: "エラー・メモリ",
    items: [
      { href: "/learn/error-handling", label: "エラーハンドリング" },
  ...
  },
  {
    label: "SwiftUI",
    items: [
      { href: "/learn/swiftui", label: "SwiftUI入門" },
      { href: "/learn/property-wrappers", label: "Property Wrapper" },
      { href: "/learn/concurrency", label: "並行処理" },
    ],
  },
  {
    label: "テスト・設計",
    items: [
      ...
      { href: "/learn/patterns", label: "設計パターン" },
      { href: "/learn/spm", label: "SPM" },
    ],
  },
  {
    label: "スキルアップ",
    items: [
      { href: "/learn/algorithms", label: "アルゴリズム" },
      { href: "/learn/advanced", label: "上級機能" },
      { href: "/learn/ios", label: "iOS開発" },
      { href: "/learn/ecosystem", label: "エコシステム" },
    ],
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center justify-between h-14">
          ...
          <Link href="/" className="flex items-center font-bold text-lg shrink-0">
            ...
            <span className="text-gray-100">SwiftLearn</span>
            <span className="text-orange-400">/&gt;</span>
          </Link>
