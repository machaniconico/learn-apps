      ...
      <section className="relative overflow-hidden py-24 px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative max-w-5xl mx-auto text-center">
          ...
          <p className="text-lg sm:text-xl text-gray-400 max-w-2xl mx-auto mb-10 leading-relaxed">
            Swiftの基礎からSwiftUI、オブジェクト指向まで。
            ブラウザ上でコードを書きながら学びましょう。
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/learn/basics"
              className="inline-flex items-center justify-center gap-2 bg-orange-500 hover:bg-orange-400 text-white font-semibold px-8 py-3 rounded-lg transition-colors"
            >
              無料で始める
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-2xl mx-auto text-center">
          <div className="bg-gradient-to-br from-orange-500/10 to-amber-600/10 border border-orange-500/20 rounded-2xl p-10">
            ...
            <Link
              href="/learn/basics"
              className="inline-flex items-center gap-2 bg-orange-500 hover:bg-orange-400 text-white font-bold px-8 py-4 rounded-xl text-lg transition-colors"
            >
              Swift基礎から始める
