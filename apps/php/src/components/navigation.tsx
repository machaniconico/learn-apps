...
const NAV_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/learn/forms", label: "フォーム・HTTP" },
    ],
  },
  {
    label: "DB・API",
    items: [
      ...
      { href: "/learn/api", label: "API開発" },
    ],
  },
  {
    label: "モダンPHP",
    items: [
      { href: "/learn/modern", label: "モダンPHP" },
      { href: "/learn/namespaces", label: "名前空間" },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/learn/datetime", label: "日付・時刻" },
    ],
  },
  {
    label: "スキルアップ",
    items: [
      { href: "/learn/frameworks", label: "フレームワーク" },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center justify-between h-14">
          ...
          <Link href="/" className="flex items-center font-bold text-lg shrink-0">
            ...
            <span className="text-gray-100">PHPLearn</span>
            <span className="text-indigo-400">/&gt;</span>
          </Link>
