...
const ALL_CATEGORIES = ["すべて", "基礎", "データ構造", "OOP", "モジュール", "Web", "データサイエンス", "テスト", "応用"] as const;

const CATEGORY_COLORS: Record<string, string> = {
  "基礎": "bg-green-500/20 text-green-400 border-green-500/30",
  "データ構造": "bg-blue-500/20 text-blue-400 border-blue-500/30",
  "OOP": "bg-purple-500/20 text-purple-400 border-purple-500/30",
  "モジュール": "bg-yellow-500/20 text-yellow-400 border-yellow-500/30",
  "Web": "bg-cyan-500/20 text-cyan-400 border-cyan-500/30",
  "データサイエンス": "bg-orange-500/20 text-orange-400 border-orange-500/30",
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-3">
            ...
            <h1 className="text-3xl font-bold text-gray-100">Python単語帳</h1>
          </div>
          <p className="text-gray-400">
            Pythonプログラミングで頻出する用語を、カテゴリ別にまとめました。
          </p>
        ...
        <div className="relative mb-5">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-3 bg-gray-900 border border-gray-700 rounded-xl text-gray-100 placeholder-gray-600 outline-none focus:border-green-500/50 transition-colors text-sm"
          />
          {query && (
            <button
              onClick={() => setQuery("")}
